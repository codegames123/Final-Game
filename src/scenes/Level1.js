...
class Level1 extends Phaser.Scene {
    ...
    create() {
        ...
        const tileset = map.addTilesetImage('neonTiles', 'level1tiles'); // test_tiles sets the position of the tiles from level1tilemap.json and level1tiles are the tiles
